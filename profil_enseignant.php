        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" data-aos="fade-right" data-aos-duration="700" data-aos-delay="200">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="dashboard_etudiant.php"><i class="fas fa-tachometer-alt"></i><span>Tableau de Bord</span></a></li>
                        ...
                        <div class="col">
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body" style="font-size: 14px;">
                                    <ul class="list-group">
                                        <li class="list-group-item"><span style="font-weight: bold;font-size: 12px;">Nom : <?php echo $nom;?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;font-size: 12px;">Prénoms : <?php echo $prenom;?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;font-size: 12px;">Position : <?php echo $position;?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;font-size: 12px;">Specialite principal : <?php echo $specialite_principal;?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">Specialite secondaire : <?php echo $specialite_secondaire;?> &nbsp;&nbsp;</span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">Adresse Email : <?php echo $_SESSION['email'];?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">Sexe : <?php echo $sexe;?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">Diplome de base : <?php echo $diplome;?>&nbsp;</span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">Adresse : <?php echo $addresse;?>&nbsp;</span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">N° Matricule : <?php echo $matricule;?></span></li>
                                        <li class="list-group-item"><span style="font-weight: bold;">Téléphone : <?php echo $telephone;?></span></li>
                                    </ul>
                                </div>
